...
import { isAbilityModelled, isItemModelled } from "./registry.ts";
...
export { isAbilityModelled, isItemModelled } from "./registry.ts";
...
export function calculate(
  ...
  return { ...result, unmodelled, effectivenessLabel: effectivenessLabel(result.typeMod) };
}
