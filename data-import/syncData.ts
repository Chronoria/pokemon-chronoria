...
/** Single-file copy for the map event dump - unlike the PBS/translation folders, this isn't
 *  always present (it's manually (re-)generated by the user via an external export tool), so
 *  a missing source file is skipped quietly rather than treated as an error. */
function copySingleFile(srcFile: string, destFile: string): boolean {
